                            ...
                            @if(isset($hero_images) && count($hero_images) > 0)
                                @foreach($hero_images as $img)
                                    <div class="swiper-slide">
                                        {{-- 
                                            NOTE: Storage::url() points to the OPTIMIZED version by default.
                                            We do NOT use loading="lazy" here because this is the "Hero" (top of page).
                                        --}}
                                ...
                                <a href="{{ route('pelukis.show', $artist) }}" class="text-decoration-none">
                                    ...
                                    <div class="artist-wrapper">
                                        ...
                                        @if($artist->artistProfile && $artist->artistProfile->profile_picture)
                                            ...
                                            <img src="{{ Storage::url($artist->artistProfile->profile_picture) }}" loading="lazy" class="artist-profile-frame" alt="{{ $artist->name }}">
                                        @else
                            ...
                            <div class="col-lg-10 col-12 mx-auto">
                                <div class="pinned custom-block custom-block-overlay">
                                    <div class="d-flex flex-column h-100">
                                        {{-- ADDED: loading="lazy" --}}
                                        <img src="{{ Storage::url($pinned_event->image_path) }}" loading="lazy" class="custom-block-image img-fluid" alt="">
                            ...
                            <div class="custom-block bg-white shadow-lg h-100 d-flex flex-column event-card">
                                ...
                                <div class="position-relative">
                                    <a href="{{ route('event.details', $event) }}">
                                        {{-- ADDED: loading="lazy" --}}
                                        <img src="{{ Storage::url($event->image_path) }}" loading="lazy" class="custom-block-image img-fluid" alt="{{ $event->title }}">
                                    </a>
                                </div>
                                    ...
                                    <a href="{{ route('artworks.show', $artwork) }}" class="custom-block-link">
                                        <div class="custom-block bg-white shadow-lg">
                                            ...
                                            <div class="custom-block-image-wrap">
                                                {{-- ADDED: loading="lazy" --}}
                                                <img src="{{ Storage::url($artwork->image_path) }}" loading="lazy" class="custom-block-image img-fluid" alt="{{ $artwork->title }}">
