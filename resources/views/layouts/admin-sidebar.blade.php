<div class="h-full px-3 py-4 overflow-y-auto bg-white dark:bg-gray-800 border-r dark:border-gray-700">
    ...
    <ul class="space-y-2 font-medium">
        ...
        {{-- News & Articles --}}
        <li>
            <a href="{{ route('admin.news.create.blade.php') }}" 
        ...
        {{-- Optimization Tool --}}
        <li>
            <a href="{{ route('admin.optimize.images') }}" 
               onclick="return confirm('This process might take a few minutes. Continue?')"
               class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                ...
                <span class="flex-1 ms-3 whitespace-nowrap">Optimize Images</span>
            </a>
        </li>
